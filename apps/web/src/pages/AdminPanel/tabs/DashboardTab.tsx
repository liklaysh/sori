  ...
  if (loading && !stats) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-sori-text-muted gap-4">
        ...
        <p className="text-xs animate-pulse tracking-widest text-sori-accent-danger uppercase font-black">Establishing Connection...</p>
      </div>
    );
  }
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-10">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3 px-1">
          ...
          <h2 className="text-[10px] font-black uppercase text-sori-text-strong tracking-[0.4em]">Integrity Nodes</h2>
